...
class List extends Component {
  ...
  componentDidMount() {
    ...
    if (match) {
      ...
      axios({
      method: 'GET',
      url :`https://61d6e1cf35f71e0017c2e86e.mockapi.io/products/${id}`,
      data : null
    }).then(res =>{
      var data =res.data;
        this.setState({
    ...
    axios.get('https://61d6e1cf35f71e0017c2e86e.mockapi.io/products').then(res => {
  ...
  onSave = (event) => {
    ...
    if (this.state.id ==''){
      if(this.state.name !== '' && this.state.price!=='' && this.state.quantity !== '' && this.state.image!==''){
        axios({
          method:'POST',
          url :`https://61d6e1cf35f71e0017c2e86e.mockapi.io/products`,
          data: {
      ...
      axios({
        method:'PUT',
        url :`https://61d6e1cf35f71e0017c2e86e.mockapi.io/products/${this.state.id}`,
        data: {
          name: this.state.name,
          price: this.state.price,
          oldPrice : this.state.oldPrice,
          ...
          <div className="col-4">
            <form onSubmit={this.onSave}>
              ...
              <div className="form-group" id = "image-edit" style={{ display: "none" }}>
                <label>Image</label>
                  <img src={"./"+this.state.image} style={{ width: "100px" }} alt="" />
              </div>
