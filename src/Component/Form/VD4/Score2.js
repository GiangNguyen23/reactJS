...
class Score2 extends Component {
    constructor(props){
        super(props);
        this.state = {
            hk1: 0,
                ...
                <table width={670} height={177} border = {0} align="center" >
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td width={261}><label><input name="hk1" type="number" min="0" max="10" size={90} onChange={this.myChangeHandler}></input></label></td>
                        </tr>
                        <tr>
                            <td width={125}><span>Điểm HK2: </span></td>
                            <td width={261}><label><input name="hk2" type="number" min="0" max="10" size={20} onChange={this.myChangeHandler}></input></label></td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td width={261}><label><input name="ketqua" type="text" readOnly value={this.state.KQ} size={20} onChange={this.myChangeHandler}></input></label></td>
                        </tr>
                        <tr>
                            <td width={125}><span>Xếp loại học lực: </span></td>
                            <td width={261}><label><input name="x" type="text" readOnly value={this.state.academicPower} size={20} onChange={this.myChangeHandler}></input></label></td>
                        </tr>
                        <tr>
